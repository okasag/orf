...
******
* **input:** Data ($X,Y$)  
* **output:** Class Probabilities $P[Y=m \mid X=x]$  

 * 1 **procedure** Ordered Forest  

    + 2 **do** Cumulative Probabilities    
        - 3 **for** $m=0,...,M$:  
            ...
            - 6 **predict** conditional probabilities as: $\hat{Y}_{m,i}=\hat{P}[Y_{m,i}=1 \mid X_i=x] = \sum^N_{i=1}\hat{w}_{m,i}(x)Y_{m,i}$  
        - 7 **endfor**  
    + 8 **endo**    
    
    + 9 **do** Class Probabilities  
        - 10 **for** $m=1,...,M$:  
 ...
 * 17 **end procedure** Ordered Forest
